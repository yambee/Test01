...
for (i=0, j={}; i<st.length; i++) {
	if (isStopCh(st[i])) { // если st[i] стопсимвол, при этом первый! (то есть w до этого не обнулялось) то добавляем строку w в объект и плюсуем ему счетчик (если слово новое, ставим 1)
