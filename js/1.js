...
for (i=0, j={}; i<st.length; i++) {
	if (st[i] === " ") { // если попался пробел
		if (j[w]) {j[w]++} else {j[w]=1}; // слово становится св-вом объекта j, а значение св-ва увеличивается на 1 или, в случае undefined, приравнивается к 1 (значит слово новое)
		w = "" // слово надо обнулить
	} else {
